...
namespace Fofx
{
    public class RelationshipRevisableDateValueRequestHelper : BaseRelationshipRevisableRequestHelper, ITimeSeriesRequestHelper
    {
        ...
        {
            string message = RelationshipArrayRequestHelper.ExceptionMsg("RelationshipRevisableDateValueRequestHelper.GetDataReader", new Exception("RelationshipRevisableDateValueRequestHelper.GetDataReader has not been implemented."));
