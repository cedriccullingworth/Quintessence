...
namespace Fofx
{
    public class RelationshipDateCharacteristicRequestHelper : BaseRelationshipRevisableRequestHelper, ITimeSeriesRequestHelper
    {
        public override INullableReader GetDataReader(int[] entites, int[] factors, DatabaseRequestArgs args)
        {
            string message = RelationshipArrayRequestHelper.ExceptionMsg("RelationshipDateCharacteristicRequestHelper.GetDataReader", new Exception("RelationshipDateCharacteristicRequestHelper.GetDataReader has not been implemented."));
