...
namespace Fofx
{
    public class RelationshipRevisableEnumValueRequestHelper : BaseRelationshipRevisableRequestHelper, ITimeSeriesRequestHelper
    {
        public override INullableReader GetDataReader(int[] entites, int[] factors, DatabaseRequestArgs args)
        {
            string message = RelationshipArrayRequestHelper.ExceptionMsg("RelationshipRevisableEnumValueRequestHelper.GetDataReader", new Exception("RelationshipRevisableEnumValueRequestHelper.GetDataReader has not been implemented."));
