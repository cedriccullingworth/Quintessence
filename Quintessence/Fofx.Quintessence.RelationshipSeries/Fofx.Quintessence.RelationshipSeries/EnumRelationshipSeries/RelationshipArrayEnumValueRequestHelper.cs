...
namespace Fofx
{
    public class RelationshipArrayEnumValueRequestHelper : BaseRelationshipRevisableRequestHelper, ITimeSeriesRequestHelper
    {
        ...
        {
            string message = RelationshipArrayRequestHelper.ExceptionMsg("RelationshipArrayEnumValueRequestHelper.GetDataReader", new Exception("RelationshipArrayEnumValueRequestHelper.GetDataReader has not been implemented."));
        ...
        protected override void Read(int[] entities, int[] timeseries, int[] relationship, DatabaseRequestArgs args, TimeSeriesDatabaseContext requester, Dictionary<QuickID, ITimeSeriesKey> keys, SortedList<ITimeSeriesKey, ITimeSeries> dbTimeSeriesResult)
        {
            ...
            helper.Read<RelationshipArrayEnumValueRequestHelper>(entities, timeseries, relationship, args, requester, keys, dbTimeSeriesResult);
