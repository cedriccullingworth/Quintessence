...
namespace Fofx
{
    public class RelationshipNumericCharacteristicRequestHelper : BaseRelationshipRevisableRequestHelper, ITimeSeriesRequestHelper
    {
        ...
        {
            string message = RelationshipArrayRequestHelper.ExceptionMsg("RelationshipNumericCharacteristicRequestHelper.GetDataReader", new Exception("RelationshipNumericCharacteristicRequestHelper.GetDataReader has not been implemented."));
