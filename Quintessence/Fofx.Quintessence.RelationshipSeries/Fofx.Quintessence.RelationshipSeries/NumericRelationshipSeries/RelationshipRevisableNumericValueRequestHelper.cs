...
namespace Fofx
{
    public class RelationshipRevisableNumericValueRequestHelper : BaseRelationshipRevisableRequestHelper, ITimeSeriesRequestHelper
    {
        public override INullableReader GetDataReader(int[] entites, int[] factors, DatabaseRequestArgs args)
        {
            string message = RelationshipArrayRequestHelper.ExceptionMsg("RelationshipRevisableNumericValueRequestHelper.GetDataReader", new Exception("RelationshipRevisableNumericValueRequestHelper.GetDataReader has not been implemented."));
        ...
        protected override void Read(int[] entities, int[] timeseries, int[] relationship, DatabaseRequestArgs args, TimeSeriesDatabaseContext requester, Dictionary<QuickID, ITimeSeriesKey> keys, SortedList<ITimeSeriesKey, ITimeSeries> dbTimeSeriesResult)
        {
            ...
            SortedList<DateTime, Revision<ConstituentNumericPoint>> pointCollection = null;
            Revision<ConstituentNumericPoint> revisionCollection = null;
            ConstituentNumericPoint constituentPoint = null;
