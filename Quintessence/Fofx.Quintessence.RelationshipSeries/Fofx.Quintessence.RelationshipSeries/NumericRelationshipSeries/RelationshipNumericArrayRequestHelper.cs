...
namespace Fofx
{
    public class RelationshipArrayNumericValueRequestHelper : BaseRelationshipRevisableRequestHelper, ITimeSeriesRequestHelper
    {
        ...
        {
            string message = RelationshipArrayRequestHelper.ExceptionMsg("RelationshipArrayNumericValueRequestHelper.GetDataReader", new Exception("RelationshipArrayNumericValueRequestHelper.GetDataReader has not been implemented."));
        ...
        protected override void Read(int[] entities, int[] timeseries, int[] relationship, DatabaseRequestArgs args, TimeSeriesDatabaseContext requester, Dictionary<QuickID, ITimeSeriesKey> keys, SortedList<ITimeSeriesKey, ITimeSeries> dbTimeSeriesResult)
        {
            ...
            helper.Read<RelationshipArrayNumericValueRequestHelper>(entities, timeseries, relationship, args, requester, keys, dbTimeSeriesResult);
